...
{
class OpenManipulatorMoveLController : public robotis_motion_controller::optimization::QPBase
{
public:
  ...
  void setDesiredTaskVel(const robotis_motion_controller::common::Vector6d & task_xdot_desired);
  void setWeights(
    const robotis_motion_controller::common::Vector6d & task_tracking_weight,
...
private:
  ...
  robotis_motion_controller::common::Vector6d task_xdot_desired_;
  robotis_motion_controller::common::Vector6d task_tracking_weight_;
