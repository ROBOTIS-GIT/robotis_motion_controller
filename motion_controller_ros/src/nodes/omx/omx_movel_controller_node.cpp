#include "motion_controller_ros/nodes/omx/omx_movel_controller_node.hpp"
...
namespace motion_controller_ros
{
          ...
          movel_goal_pose_(Eigen::Affine3d::Identity())
    {
        ...
        try {
            ...
            qp_controller_ = std::make_shared<motion_controller::controllers::OMXMoveLController>(
    ...
    void OmxMoveLControllerNode::moveLCallback(const motion_controller_msgs::msg::MoveL::SharedPtr msg)
    {
    ...
    Eigen::Affine3d OmxMoveLControllerNode::poseMsgToEigen(const geometry_msgs::msg::PoseStamped& pose_msg) const
    {
    ...
    motion_controller::common::Vector6d OmxMoveLControllerNode::computeDesiredVelocity(
...
int main(int argc, char** argv)
{
    ...
    auto node = std::make_shared<motion_controller_ros::OmxMoveLControllerNode>();
    rclcpp::spin(node);
    rclcpp::shutdown();
    return 0;
}
