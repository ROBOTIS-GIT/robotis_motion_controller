...
#include "motion_controller_ros/nodes/ai_worker/ai_worker_movel_controller_node.hpp"
  ...
  left_gripper_position_(0.0)
{
  ...
  try {
    ...
    qp_controller_ =
      std::make_shared<motion_controller::controllers::AIWorkerMoveLController>(
...
motion_controller::common::Vector6d AIWorkerMoveLController::computeDesiredVelocity(
...
void AIWorkerMoveLController::controlLoopCallback()
{
  ...
  try {
    ...
    motion_controller::common::Vector6d right_weight = motion_controller::common::Vector6d::Ones();
    motion_controller::common::Vector6d left_weight = motion_controller::common::Vector6d::Ones();
...
int main(int argc, char ** argv)
{
  ...
  auto node = std::make_shared<motion_controller_ros::AIWorkerMoveLController>();
  rclcpp::spin(node);
  rclcpp::shutdown();
  return 0;
}
