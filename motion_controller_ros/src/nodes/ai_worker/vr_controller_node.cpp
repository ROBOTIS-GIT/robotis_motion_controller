...
void VRController::controlLoopCallback()
{
  ...
  try {
    ...
    motion_controller::common::Vector6d right_elbow_desired_vel =
      motion_controller::common::Vector6d::Zero();
    motion_controller::common::Vector6d left_elbow_desired_vel =
      motion_controller::common::Vector6d::Zero();
    ...
    motion_controller::common::Vector6d weight_right_elbow =
      motion_controller::common::Vector6d::Zero();
    motion_controller::common::Vector6d weight_left_elbow =
      motion_controller::common::Vector6d::Zero();
