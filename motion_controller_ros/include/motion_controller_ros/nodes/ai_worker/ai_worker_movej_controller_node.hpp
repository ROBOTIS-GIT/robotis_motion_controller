...
#include "motion_controller_core/controllers/ai_worker/ai_worker_movej_controller.hpp"
...
private:
  ...
  std::shared_ptr<motion_controller::controllers::AIWorkerMoveJController> qp_filter_;
