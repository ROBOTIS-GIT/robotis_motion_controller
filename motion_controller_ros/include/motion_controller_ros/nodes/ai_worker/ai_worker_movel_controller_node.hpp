...
#include "motion_controller_core/controllers/ai_worker/ai_worker_movel_controller.hpp"
...
private:
  ...
  std::shared_ptr<motion_controller::controllers::AIWorkerMoveLController> qp_controller_;
