...
{
    /**
     * @brief OMX controller node for interactive-marker following.
     */
    class OmxControllerNode : public rclcpp::Node
    {
    public:
        OmxControllerNode();
        ~OmxControllerNode();
    ...
    private:
        ...
        std::shared_ptr<motion_controller::controllers::OpenManipulatorController> qp_controller_;
