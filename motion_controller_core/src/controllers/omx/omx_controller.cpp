...
namespace controllers
{
    ...
    void OMXController::setControlledLink(const std::string& controlled_link)
    {
    ...
    void OMXController::setControllerParams(
    ...
    bool OMXController::getOptJointVel(Eigen::VectorXd& opt_qdot)
    {
        Eigen::MatrixXd sol;
        if (!solveQP(sol)) {
    ...
    void OMXController::setBoundConstraint()
    {
    ...
    void OMXController::setIneqConstraint()
    {
    ...
    void OMXController::setEqConstraint()
    {
