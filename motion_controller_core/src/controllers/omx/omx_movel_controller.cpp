...
{
    OMXMoveLController::OMXMoveLController(
    ...
    void OMXMoveLController::setControlledLink(const std::string& controlled_link)
    {
    ...
    void OMXMoveLController::setControllerParams(
    ...
    bool OMXMoveLController::getOptJointVel(Eigen::VectorXd& opt_qdot)
    {
        Eigen::MatrixXd sol;
        if (!solveQP(sol)) {
    ...
    void OMXMoveLController::setCost()
    {
    ...
    void OMXMoveLController::setBoundConstraint()
    {
    ...
    void OMXMoveLController::setIneqConstraint()
    {
    ...
    void OMXMoveLController::setEqConstraint()
    {
