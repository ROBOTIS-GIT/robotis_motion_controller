...
#include "robotis_motion_controller_ros/nodes/omx/omx_movel_controller_node.hpp"
...
robotis_motion_controller::common::Vector6d OmxMoveLControllerNode::computeDesiredVelocity(
...
int main(int argc, char ** argv)
{
  ...
  auto node = std::make_shared<robotis_motion_controller_ros::OmxMoveLControllerNode>();
  rclcpp::spin(node);
  rclcpp::shutdown();
  return 0;
}
