...
#include "robotis_motion_controller_ros/nodes/omx/omx_movej_controller_node.hpp"
...
int main(int argc, char ** argv)
{
  ...
  auto node = std::make_shared<robotis_motion_controller_ros::OmxMoveJControllerNode>();
  rclcpp::spin(node);
  rclcpp::shutdown();
  return 0;
}
