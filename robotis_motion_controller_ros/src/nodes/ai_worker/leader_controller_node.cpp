...
#include "robotis_motion_controller_ros/nodes/ai_worker/leader_controller_node.hpp"
...
int main(int argc, char ** argv)
{
  ...
  auto node = std::make_shared<robotis_motion_controller_ros::LeaderController>();
  rclcpp::spin(node);
  rclcpp::shutdown();
  return 0;
}
