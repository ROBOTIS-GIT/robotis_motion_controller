...
#include "robotis_motion_controller_ros/nodes/ai_worker/vr_controller_node.hpp"
#include <algorithm>
#include <cmath>
  ...
  dt_(0.01)
{
  ...
  try {
    ...
    qp_controller_ =
      std::make_shared<robotis_motion_controller::controllers::VRController>(kinematics_solver_,
        dt_);
...
void VRController::controlLoopCallback()
{
  ...
  try {
    ...
    robotis_motion_controller::common::Vector6d right_elbow_desired_vel =
      robotis_motion_controller::common::Vector6d::Zero();
    robotis_motion_controller::common::Vector6d left_elbow_desired_vel =
      robotis_motion_controller::common::Vector6d::Zero();
    ...
    robotis_motion_controller::common::Vector6d weight_right =
      robotis_motion_controller::common::Vector6d::Ones();
    robotis_motion_controller::common::Vector6d weight_left =
      robotis_motion_controller::common::Vector6d::Ones();
    ...
    robotis_motion_controller::common::Vector6d weight_right_elbow =
      robotis_motion_controller::common::Vector6d::Zero();
    robotis_motion_controller::common::Vector6d weight_left_elbow =
      robotis_motion_controller::common::Vector6d::Zero();
...
robotis_motion_controller::common::Vector6d VRController::computeDesiredVelocity(
...
int main(int argc, char ** argv)
{
  ...
  auto node = std::make_shared<robotis_motion_controller_ros::VRController>();
  rclcpp::spin(node);
  rclcpp::shutdown();
  return 0;
}
