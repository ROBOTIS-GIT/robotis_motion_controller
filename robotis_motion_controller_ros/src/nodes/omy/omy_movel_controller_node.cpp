...
#include "robotis_motion_controller_ros/nodes/omy/omy_movel_controller_node.hpp"
  ...
  try {
    ...
    kinematics_solver_ =
      std::make_shared<robotis_motion_controller::kinematics::KinematicsSolver>(urdf_path_,
        srdf_path_);
    qp_controller_ =
      std::make_shared<robotis_motion_controller::controllers::OpenManipulatorMoveLController>(
...
robotis_motion_controller::common::Vector6d OmyMoveLControllerNode::computeDesiredVelocity(
...
void OmyMoveLControllerNode::controlLoopCallback()
{
  ...
  try {
    ...
    robotis_motion_controller::common::Vector6d desired_task_vel =
      robotis_motion_controller::common::Vector6d::Zero();
    ...
    robotis_motion_controller::common::Vector6d task_weight =
      robotis_motion_controller::common::Vector6d::Zero();
...
int main(int argc, char ** argv)
{
  ...
  auto node = std::make_shared<robotis_motion_controller_ros::OmyMoveLControllerNode>();
  rclcpp::spin(node);
  rclcpp::shutdown();
  return 0;
}
